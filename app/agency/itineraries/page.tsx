...
import { Search, Plus, Library, Copy } from "lucide-react";
...
export default function ItinerariesPage() {
  ...
  const handleItineraryStatusChange = (
    ...
    setActiveTab(status === "archived" ? "archive" : "draft");
  };
      ...
      <div className="mx-auto px-10 py-5">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Button variant="outline" className="gap-2 border-[#D4AA25] text-[#D4AA25]" asChild>
              <Link href="/agency/tour-library">
        ...
        <Tabs
          value={activeTab}
          onValueChange={(tab) => {
            if (tab === "draft" || tab === "library" || tab === "archive") setActiveTab(tab);
          }}
          className="w-full"
        >
          <TabsList className="mb-2">
            <TabsTrigger value="draft">Draft Trips ({draftCount})</TabsTrigger>
            <TabsTrigger value="library">My Library ({publishedCount})</TabsTrigger>
